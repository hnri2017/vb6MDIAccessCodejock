...
Private Sub Command1_Click()
    ...
    If Len(strDept) = 0 Then strDept = 0
...
Private Sub Command2_Click()
    ...
    Else
        ...
        If blnDept Then rsUser.Fields("DeptID") = CLng(strDept)
...
'    strSQL = "SELECT * FROM tb_Test_Sys_User WHERE UserAutoID ='" & strUID & "'"
    strSQL = "SELECT * FROM tb_Test_Sys_User WHERE UserAutoID =" & CLng(strUID)
    Set rsUser = gfBackRecordset(strSQL)
    If rsUser.State = adStateClosed Then GoTo LineEnd
    If rsUser.RecordCount = 0 Then
